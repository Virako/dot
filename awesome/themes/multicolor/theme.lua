...
local mytextclock = wibox.widget.textclock(markup("#de5e1e", " %H:%M ") .. markup("#7788af", " %d-%m-%Y "))
mytextclock.font = theme.font

-- Calendar
calendar({
    today = '<b><span color="#de5e1e">%2i</span></b>',
    empty_sep = '   .',
    week_col = '   '
}):attach(mytextclock)
...
fsicon:buttons(awful.util.table.join( awful.button({}, 1,
    function()
...
cpuicon:buttons(awful.util.table.join( awful.button({}, 1,
    function()
        awful.util.spawn_with_shell(awful.util.terminal .. " -e htop")
    end)
))
...
wifiwidget:buttons(awful.util.table.join( awful.button({}, 1,
    function()
        awful.util.spawn_with_shell(awful.util.terminal .. " -e wicd-curses")
    end)
))
...
memicon:buttons(awful.util.table.join( awful.button({}, 1,
    function()
        awful.util.spawn_with_shell(awful.util.terminal .. " -e htop")
    end)
))
